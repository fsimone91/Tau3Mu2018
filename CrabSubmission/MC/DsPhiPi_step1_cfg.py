...
# with command line options: Configuration/GenProduction/python/DsPhiPi_EvtGen_cfi.py --fileout file:out.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --step GEN,SIM --nThreads 4 --geometry DB:Extended --era Run2_2018 --python_filename DsPhiPi_step1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 1
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/DsPhiPi_EvtGen_cfi.py nevts:1'),
...
process.MuFilter = cms.EDFilter("MCParticlePairFilter",
    ...
    MinPt = cms.untracked.vdouble(2.85, 1.9),
...
process.generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.00015),
