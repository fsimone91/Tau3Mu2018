...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://xrootd-cms.infn.it//store/data/Run2018A/DoubleMuonLowMass/AOD/17Sep2018-v1/120000/3C6EECC5-5787-AC43-ACF0-3BE40CE1291C.root')
)
...
process.ThreeMuonsVtxKalmanFit = cms.EDProducer("KalmanVertexFitCompositeCandProducer",
    src = cms.InputTag("ThreeMuonsCand")
)


process.ThreeMuonsVtxKinFit = cms.EDProducer("KinematicVertexFitCompositeCandProducer",
    src = cms.InputTag("ThreeMuonsCand")
)
...
process.Tau3MuHLTFilter = cms.EDFilter("HLTHighLevel",
...
process.PlotsAfter3Muons = cms.EDAnalyzer("RecoMuonAnalyzer",
...
process.PlotsAfterTauCand = cms.EDAnalyzer("RecoMuonAnalyzer",
    muonsInputTag = cms.InputTag("looseMuons")
)


process.PlotsAfterTauCandSel = cms.EDAnalyzer("RecoMuonAnalyzer",
    muonsInputTag = cms.InputTag("looseMuons")
)
...
process.PlotsMatchedMuonsHLT = cms.EDAnalyzer("RecoMuonAnalyzer",
    muonsInputTag = cms.InputTag("PatMuons")
)
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('102X_dataRun2_v11'),
...
process.ThreeMuonSelSeq = cms.Sequence(process.InitialPlots+process.Tau3MuHLTFilter+process.PatMuons+process.PlotsAfterTrigger+process.looseMuons+process.PlotsAfterLooseMuon+process.ThreeMuonsFilter+process.PlotsAfter3Muons+process.ThreeMuonsCand+process.ThreeMuonsCandFilter+process.PlotsAfterTauCand+process.ThreeMuonsVtxKalmanFit)


process.Tau3MuSkim = cms.Path(process.ThreeMuonSelSeq+process.TreeMakerBkg)
