...
config.General.requestName = 'SkimPhiPi_DoubleMuonLowMass_Run2017E_31July_TM_newSplit'
...
config.Data.outputDatasetTag = 'SkimPhiPi_DoubleMuonLowMass_Run2017E_31July_TM_newSplit'
